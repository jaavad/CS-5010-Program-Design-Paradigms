...
/**
 * This class represents a single, immutable 2D point represented
 * using Cartesian coordinates. The coordinates of this point are integral
 * values.
 */
public final class Point2D {
  ...
  /**
   * Return if this point is the same as another. Two points are the same
